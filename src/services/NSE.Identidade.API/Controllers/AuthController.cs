...
namespace NSE.Identidade.API.Controllers
{
    ...
    public class AuthController : MainController
    {
        ...
        public async Task<ActionResult> Registrar(UsuarioRegistro usuarioRegistro)
        {
            ...
            IdentityResult result = await _authenticationService.UserManager.CreateAsync(user, usuarioRegistro.Senha);
        ...
        {
            IdentityUser usuario = await _authenticationService.UserManager.FindByEmailAsync(usuarioRegistro.Email);
