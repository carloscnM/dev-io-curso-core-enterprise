...
namespace NSE.Pedidos.Domain.Vouchers.Specs
{
    public class VoucherValidation : SpecValidator<Voucher>
    {
        ...
        {
            VoucherDataSpecification dataSpec = new VoucherDataSpecification();
            VoucherQuantidadeSpecification qtdeSpec = new VoucherQuantidadeSpecification();
            VoucherAtivoSpecification ativoSpec = new VoucherAtivoSpecification();
